...
func (s *server) ServeHTTP(w http.ResponseWriter, r *http.Request) {
    ...
    default:
        ...
        util.SendResponse(w, http.StatusBadRequest, "invalid method:%v", r.Method)
        return
    }
    ...
    if !ok {
        ...
        util.SendResponse(w, http.StatusBadRequest, "invalid request:%v", r)
        return
    }
